...
if __name__ == '__main__':
    #test_the_attack()
    encrypted = encrypt(b"Hello, this is a public message. This message contains no flags.")
    print(encrypted)
    cracked = attack(encrypted)
    print(cracked)
	
    encrypted = bytes.fromhex('f6816a603cefb0a0fd8a23a804b921bf489116fcc11d650c6ffb3fc0aae9393409c8f4f24c3d4b72ccea787e84de7dd0')
    print(encrypted)
    cracked = attack(encrypted)
    print(cracked)
